...
const dashboardInfo = info => {
  ...
  return {
    ...
    changelogs: [{
      ...
      list: [" Add 3 new advanced video player blocks (React, Video.js, Vidstack)", " Fix build error"],
      type: "new"
    }, {
      version: "1.0.6 - 20 Nov 24",
    ...
    proFeatures: ["Advanced React Video Player Engine", "Industry Standard Video.js Player Support", "State-of-the-Art Vidstack Player Engine", "HLS (.m3u8) Streaming Support", "Advanced Color & Typography Customization", "Quality Switcher & Multiple Subtitles Support", "Custom Playback Speeds (0.5x to 2x)", "External Media Sources (Amazon S3, DigitalOcean, etc.)", "Optimized Preload & Media Load Strategies", "Custom Border Radius & Player UI Styling", "Show/Hide Specific Player Controls"],
    startButton: {
      label: "Start Now",
